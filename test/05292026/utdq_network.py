...
os.environ["UTDQUAKE_ROOT"] = "/groups/igonin/ecastillo/bck_utdq/test_05292026/UTDQuake"
os.environ["UTDQUAKE_DAS_ROOT"] = "/groups/igonin/ecastillo/bck_utdq/test_05292026/UTDQuake_DAS"
...
net_path.mkdir(exist_ok=True, parents=True)
print(f"Saving figure to {figures_path}")

dataset = utdq.Dataset(das=das)
# print(dataset)
