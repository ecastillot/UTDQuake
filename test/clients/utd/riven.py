...
test_catalog.query(starttime="2024-12-20 00:56:40")
picks = test_catalog.get_picks(picks_path='/home/edc240000/riven/25032025/all_dec_2024_TX_picks.db',author="manual")
print(picks)
# events = test_catalog.events
# picks = events.get_picks(picks_path='/home/edc240000/riven/25032025/all_dec_2024_TX_picks.db',author="manual")
# print(events.data)
# print(picks)

# ex = events.query(starttime="2024-12-20 00:56:40")
# picks = ex.get_picks(picks_path='/home/edc240000/riven/25032025/all_dec_2024_TX_picks.db',author="manual")
# print(ex.data)
# print(picks)


# print(test_catalog.events)
exit()
...
# print(test_picks.events)

print(test_picks)
print(test_picks.data)
