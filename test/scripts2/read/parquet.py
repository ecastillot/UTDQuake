...
# path = "/groups/igonin/ecastillo/UTDQuake/manifests/picks/network=tx.parquet"
# path = "/groups/igonin/ecastillo/UTDQuake/picks/network=RSNC.parquet"
path = "/groups/igonin/ecastillo/UTDQuake/manifests2/qc/picks/network=tx.parquet"
...
# print(df_ori[["travel_time_zscore"]].describe())
# print(df_ori.info())
# #check if it's unqiue
# print(df_ori[["pick_id"]].nunique().sum())
# print(df_ori[["resource_id"]].duplicated().sum())
# print(df_ori.info())
