...
def download_utdquake(local_dir, networks, repo_id: str = "ecastillot/UTDQuake",
    ...
    repo_id : str
        Hugging Face repository ID (default: "ecastillot/UTDQuake").
    repo_type : str
        Type of repository (default: "dataset").
    Returns
    -------
    Path
